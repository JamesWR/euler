...
# t = min_product_sum_list_num(12)
# print remove_duplicates_and_add(t)

# new aproch

# def new_aproch(max_length):
#	for i in range(4,2*max_length+1):
# get Prime factors i
# solve posible lengths i
# end
...
def recuse_over_factors(factor_list,prefix):
	...
	for group_num in range(1,len(factor_list)):
		...
		solutions_with_grouped_values_and_passed_values = recuse_over_factors(list_with_group,solutions_with_passed_values)
